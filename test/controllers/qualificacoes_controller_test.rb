...
class QualificacoesControllerTest < ActionController::TestCase
  ...
  test "should create qualificacao" do
    assert_difference('Qualificacao.count') do
      post :create, qualificacao: { cliente_id: @qualificacao.cliente_id, integer: @qualificacao.integer, loja_id: @qualificacao.loja_id, nota: @qualificacao.nota, valor_gasto: @qualificacao.valor_gasto }
    end
  ...
  test "should update qualificacao" do
    patch :update, id: @qualificacao, qualificacao: { cliente_id: @qualificacao.cliente_id, integer: @qualificacao.integer, loja_id: @qualificacao.loja_id, nota: @qualificacao.nota, valor_gasto: @qualificacao.valor_gasto }
    assert_redirected_to qualificacao_path(assigns(:qualificacao))
  end
